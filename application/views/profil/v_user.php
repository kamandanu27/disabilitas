			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						...
						<form action="<?php echo base_url() ?>profil/updateuser" method="post" enctype="multipart/form-data">
                            <div class="card-body">
								...
								<div class="form-group">
									...
									<br>
									<img src="<?= base_url() ?>public/image/upload/<?= $detail['foto_user'] ?>" width="150px"  alt="User Image">
