					...
					<div class="card">
						...
						<form action="<?php echo base_url() ?>profil/updatepemohon" method="post" enctype="multipart/form-data">
                            <div class="card-body">
								...
								<div class="form-group">
                                    <label for="exampleInputEmail1">Foto Pemohon :</label>
									<br>
									<img src="<?= base_url() ?>public/image/upload/pemohon/<?= $detail['foto_pemohon'] ?>" width="150px"  alt="User Image">
                                    <input type="file" class="form-control" id="foto_pemohon" name="foto_pemohon">
								</div>
