				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3> Tambah Data Alat Bantu </h3>
						</div>

						<form action="<?php echo base_url() ?>alatbantu/insert" method="post">
                            <div class="card-body">

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama Alat Bantu :</label>
                                    <input alatbantu="text" class="form-control" id="nama_alatbantu" name="nama_alatbantu">
                                </div>
